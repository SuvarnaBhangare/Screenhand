...
const client = new Client({ name: 'x-delete-diag-after-menu-click', version: '1.0.0' }, { capabilities: {} });
...
try {
  ...
  await sleep(500);
  log.afterDeleteMenuShot = await call('screenshot', { windowId: win.windowId });
