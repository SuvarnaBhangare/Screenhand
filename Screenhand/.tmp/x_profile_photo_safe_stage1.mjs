...
const OUT = '/Users/khushi/Documents/Automator/Screenhand/.tmp/x_profile_photo_safe_stage1_report.json';
...
const client = new Client({ name: 'x-profile-photo-safe-stage1', version: '1.0.0' }, { capabilities: {} });
...
try {
  ...
  const win = parseWindows(windowsRes.text)
  ...
  report.steps.push({ step: 'screenshotFile', result: shotFile });
