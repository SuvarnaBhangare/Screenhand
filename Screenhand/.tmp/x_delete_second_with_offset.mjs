...
const client = new Client({ name: 'x-delete-second-with-offset', version: '1.0.0' }, { capabilities: {} });
...
try {
  ...
  await sleep(450);
  log.confirmViaOffset = await call('click_text', { windowId: win.windowId, text: 'Delete post?', offset_y: 115 });
  await sleep(1100);
